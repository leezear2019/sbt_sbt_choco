...
public class XCSPParser implements XCallbacks2 {
     ...
     */
    public HashMap<XVariables.XVarInteger, IntVar> mvars;
    ...
    // 用于设定allDiff的相容性算法
    private String allDiffConsistency;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void buildCtrAllDifferent(String id, XNodeParent<XVariables.XVarInteger>[] trees) {
        ...
        model.allDifferent(elts, allDiffConsistency).post();
    }

    @Override
    public void buildCtrAllDifferent(String id, XVariables.XVarInteger[] list) {
        model.allDifferent(vars(list), allDiffConsistency).post();
    }
